                ...
                return (
                  <div
                    ...
                    className={`px-4 py-3 text-sm ${
                      n.is_read ? 'text-gray-500' : 'text-gray-800 bg-blue-50/40 font-medium'
                    }`}
                  >
                    ...
                    {/* Inline confirm/reject for SESSION_BOOKING */}
                    {isBooking && (
                      <div className="mt-1">
                        {as.mode === 'idle' && (
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="flex-1 py-1.5 rounded-lg text-xs font-semibold bg-red-50 text-red-600 hover:bg-red-100 border border-red-200 transition-colors"
                            >
                              Decline
                            </button>
                          </div>
                        ...
                        {as.mode === 'confirming' && (
                          <div className="space-y-2">
                            <input
                              ...
                              className="w-full text-xs border border-gray-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-indigo-400"
                            />
                            <div className="flex gap-2">
                              <button
                        ...
                        {as.mode === 'error' && (
                          <div className="space-y-1.5">
                            <p className="text-xs text-red-600">{as.resultMessage}</p>
                            <button
                              onClick={() => setActionMode(n.id, { mode: 'idle' })}
