      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1">
          ...
          <select
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#3B48E8]"
          >
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#3B48E8] resize-none"
          />
        </div>
        {error && (
